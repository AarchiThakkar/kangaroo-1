...
function setup() {
  ...
  jungle = createSprite(00,00,800,20);
  jungle.addImage("jungle",jungleImage);
  jungle.scale=0.5
  jungle.x = width /2;
  
  kangaroo=createSprite(50,250,20,10);
...
//Create a sprite for Invisible ground and place it at the bottom side of the screen.
  invisibleGround=createSprite(0,380,900,40);
...
function spawnShrubs() {
  ...
  if (frameCount % 150 === 0) {
    shrub=createSprite(800,350,50,50)
    camera.position.x= shrub.x;
